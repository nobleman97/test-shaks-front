...
export default function AboutUs(){ 
    ...
    <section className="pb-[76px] bg-white">
        ...
        <section className="flex flex-row px-[10.4%] gap-[46px]  bg-white text-black ">
            ...
            <h2 className="text-[36px] font-semibold">Why we do it</h2>

                <p>Effective execution comes from a winning strategy: knowing what needs to be done and in what order to help our clients reach their goals. We believe in helping you hit your milestones while keeping things &apos;lean and mean&apos; so your brand can be more and do more.
